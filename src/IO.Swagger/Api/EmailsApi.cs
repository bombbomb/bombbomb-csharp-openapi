...
namespace IO.Swagger.Api
{
    ...
    public partial class EmailsApi : IEmailsApi
    {
        ...
        public ApiResponse<Object> GetAllTemplatesForCurrentUserWithHttpInfo (bool? quickSendOnly = null)
        {
            ...
            // e.g. /pet/{petId}.{format} becomes /pet/{petId}.json
            localVarPathParams.Add("format", "json");
            if (quickSendOnly != null) localVarQueryParams.Add("quickSendOnly", Configuration.ApiClient.ParameterToString(quickSendOnly)); // query parameter
        ...
        public ApiResponse<Object> GetTemplateHtmlForTemplateIdWithHttpInfo (string templateId, string renderVariables = null)
        {
            ...
            if (renderVariables != null) localVarQueryParams.Add("renderVariables", Configuration.ApiClient.ParameterToString(renderVariables)); // query parameter
        ...
        public ApiResponse<Object> GetVideoQuickSenderDataWithHttpInfo (string message = null, string subject = null, string videoId = null, string templateId = null, string commaDelimEmails = null)
        {
            ...
            if (templateId != null) localVarQueryParams.Add("templateId", Configuration.ApiClient.ParameterToString(templateId)); // query parameter
            if (commaDelimEmails != null) localVarQueryParams.Add("commaDelimEmails", Configuration.ApiClient.ParameterToString(commaDelimEmails)); // query parameter
