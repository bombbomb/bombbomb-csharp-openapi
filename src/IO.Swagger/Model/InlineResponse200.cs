...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse200 :  IEquatable<InlineResponse200>, IValidatableObject
    {
        ...
        public InlineResponse200(int? TotalPages = default(int?), List<ClientGroupAssetMetaData> Items = default(List<ClientGroupAssetMetaData>))
        {
        ...
        public List<ClientGroupAssetMetaData> Items { get; set; }
