...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CurriculumWithProgress :  IEquatable<CurriculumWithProgress>, IValidatableObject
    {
        /// <summary>
        ...
        public CurriculumWithProgress(List<CurriculumUserProgress> Progress = default(List<CurriculumUserProgress>), string Id = default(string), string Name = default(string), string HtmlIntro = default(string), string ImgUrl = default(string), int? ItemCount = default(int?), string RenderAs = default(string), bool? VisibleToAllUsers = default(bool?))
        {
        ...
        {
            return this.Equals(input as CurriculumWithProgress);
        }

        /// <summary>
        /// Returns true if CurriculumWithProgress instances are equal
        /// </summary>
        /// <param name="input">Instance of CurriculumWithProgress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CurriculumWithProgress input)
        {
            if (input == null)
                return false;
