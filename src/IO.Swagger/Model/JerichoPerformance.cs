...
namespace IO.Swagger.Model
{
    ...
    public partial class JerichoPerformance :  IEquatable<JerichoPerformance>
    {
        ...
        public JerichoPerformance(int? Sent = null, int? UniqueViews = null, int? UniqueLandingPageViews = null, int? LandingPageViews = null, int? Delivered = null, int? Bounce = null, int? Open = null, int? Click = null, int? VideoPlay = null, int? AbuseComplaints = null, int? Contacts = null)
        {
            this.Sent = Sent;
