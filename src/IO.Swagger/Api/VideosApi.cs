...
namespace IO.Swagger.Api
{
    ...
    public interface IVideosApi : IApiAccessor
    {
        ...
        /// <returns>VideoEncodingStatusResponse</returns>
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="videoId">The video&#39;s id.</param>
        /// <returns>ApiResponse of VideoEncodingStatusResponse</returns>
        ApiResponse<VideoEncodingStatusResponse> GetVideoEncodingStatusWithHttpInfo (string videoId);
        /// <summary>
        ...
        /// <param name="thumbnail">The thumbnail being uploaded</param>
        /// <param name="custom">The default email to use. (optional)</param>
        /// <returns></returns>
        ...
        ApiResponse<Object> UpdateVideoThumbnailV2WithHttpInfo (string videoId, string thumbnail, bool? custom = null);
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="videoId">The video&#39;s id.</param>
        /// <returns>Task of VideoEncodingStatusResponse</returns>
        System.Threading.Tasks.Task<VideoEncodingStatusResponse> GetVideoEncodingStatusAsync (string videoId);
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="videoId">The video&#39;s id.</param>
        /// <returns>Task of ApiResponse (VideoEncodingStatusResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<VideoEncodingStatusResponse>> GetVideoEncodingStatusAsyncWithHttpInfo (string videoId);
        /// <summary>
        /// Get Live Video Recorder HTML
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task UpdateVideoThumbnailV2Async (string videoId, string thumbnail, bool? custom = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> UpdateVideoThumbnailV2AsyncWithHttpInfo (string videoId, string thumbnail, bool? custom = null);
    ...
    public partial class VideosApi : IVideosApi
    {
        ...
        /// <param name="videoId">The video&#39;s id.</param>
        /// <returns>VideoEncodingStatusResponse</returns>
        public VideoEncodingStatusResponse GetVideoEncodingStatus (string videoId)
        {
             ApiResponse<VideoEncodingStatusResponse> localVarResponse = GetVideoEncodingStatusWithHttpInfo(videoId);
        ...
        /// <param name="videoId">The video&#39;s id.</param>
        /// <returns>ApiResponse of VideoEncodingStatusResponse</returns>
        public ApiResponse< VideoEncodingStatusResponse > GetVideoEncodingStatusWithHttpInfo (string videoId)
        {
            // verify the required parameter 'videoId' is set
            if (videoId == null)
                throw new ApiException(400, "Missing required parameter 'videoId' when calling VideosApi->GetVideoEncodingStatus");
            ...
            {
                Exception exception = ExceptionFactory("GetVideoEncodingStatus", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<VideoEncodingStatusResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (VideoEncodingStatusResponse) Configuration.ApiClient.Deserialize(localVarResponse, typeof(VideoEncodingStatusResponse)));
        ...
        /// <param name="videoId">The video&#39;s id.</param>
        /// <returns>Task of VideoEncodingStatusResponse</returns>
        public async System.Threading.Tasks.Task<VideoEncodingStatusResponse> GetVideoEncodingStatusAsync (string videoId)
        {
             ApiResponse<VideoEncodingStatusResponse> localVarResponse = await GetVideoEncodingStatusAsyncWithHttpInfo(videoId);
             return localVarResponse.Data;
        ...
        /// <param name="videoId">The video&#39;s id.</param>
        /// <returns>Task of ApiResponse (VideoEncodingStatusResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<VideoEncodingStatusResponse>> GetVideoEncodingStatusAsyncWithHttpInfo (string videoId)
        {
            // verify the required parameter 'videoId' is set
            if (videoId == null)
                throw new ApiException(400, "Missing required parameter 'videoId' when calling VideosApi->GetVideoEncodingStatus");
        ...
        /// <param name="custom">The default email to use. (optional)</param>
        /// <returns></returns>
        public void UpdateVideoThumbnailV2 (string videoId, string thumbnail, bool? custom = null)
        {
        ...
        /// <param name="custom">The default email to use. (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> UpdateVideoThumbnailV2WithHttpInfo (string videoId, string thumbnail, bool? custom = null)
        {
            // verify the required parameter 'videoId' is set
            if (videoId == null)
                throw new ApiException(400, "Missing required parameter 'videoId' when calling VideosApi->UpdateVideoThumbnailV2");
            // verify the required parameter 'thumbnail' is set
            if (thumbnail == null)
                throw new ApiException(400, "Missing required parameter 'thumbnail' when calling VideosApi->UpdateVideoThumbnailV2");

            var localVarPath = "/videos/thumbnail";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            localVarPathParams.Add("format", "json");
            if (videoId != null) localVarFormParams.Add("videoId", Configuration.ApiClient.ParameterToString(videoId)); // form parameter
            if (custom != null) localVarFormParams.Add("custom", Configuration.ApiClient.ParameterToString(custom)); // form parameter
            if (thumbnail != null) localVarFormParams.Add("thumbnail", Configuration.ApiClient.ParameterToString(thumbnail)); // form parameter
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("UpdateVideoThumbnailV2", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="custom">The default email to use. (optional)</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task UpdateVideoThumbnailV2Async (string videoId, string thumbnail, bool? custom = null)
        {
             await UpdateVideoThumbnailV2AsyncWithHttpInfo(videoId, thumbnail, custom);
        ...
        /// <param name="custom">The default email to use. (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> UpdateVideoThumbnailV2AsyncWithHttpInfo (string videoId, string thumbnail, bool? custom = null)
        {
            // verify the required parameter 'videoId' is set
            if (videoId == null)
                throw new ApiException(400, "Missing required parameter 'videoId' when calling VideosApi->UpdateVideoThumbnailV2");
