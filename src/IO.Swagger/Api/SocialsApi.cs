...
namespace IO.Swagger.Api
{
    ...
    public partial class SocialsApi : ISocialsApi
    {
        ...
        public ApiResponse<Object> GetSocialArticlePropertiesWithHttpInfo (string emailId, string socialContentId)
        {
            ...
            if (emailId != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "emailId", emailId)); // query parameter
            if (socialContentId != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "socialContentId", socialContentId)); // query parameter
        ...
        public ApiResponse<Object> GetSocialProfilePropertiesWithHttpInfo (string socialType)
        {
            ...
            if (socialType != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "socialType", socialType)); // query parameter
