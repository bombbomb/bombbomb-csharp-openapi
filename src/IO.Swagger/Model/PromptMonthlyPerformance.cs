...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PromptMonthlyPerformance :  IEquatable<PromptMonthlyPerformance>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PromptMonthlyPerformance" /> class.
        /// </summary>
        ...
        public PromptMonthlyPerformance(string StartDate = default(string), string EndDate = default(string), string UserBatchListsIdHelper = default(string), string PromptIdHelper = default(string))
        {
        ...
        {
            return this.Equals(input as PromptMonthlyPerformance);
        }

        /// <summary>
        /// Returns true if PromptMonthlyPerformance instances are equal
        /// </summary>
        /// <param name="input">Instance of PromptMonthlyPerformance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PromptMonthlyPerformance input)
        {
            if (input == null)
                return false;
